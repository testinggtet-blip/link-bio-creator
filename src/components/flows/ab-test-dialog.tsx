...
export function ABTestDialog({ open, onOpenChange, onEditVariation, onSave }: ABTestDialogProps) {
  ...
  const handleSaveVariation = (variationId: string, template: string) => {
    setVariations(prev => prev.map(v => 
      v.id === variationId 
        ? { ...v, subtitle: template ? `Template: ${template}` : 'You still have work to do' }
        : v
    ));
    ...
    <>
        ...
        <DialogContent className="max-w-md p-0 gap-0 max-h-[90vh] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              {/* Choose Winner by - RADIO BUTTONS */}
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={() => setTestParams({ ...testParams, winnerBy: 'opened' })}
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={() => setTestParams({ ...testParams, winnerBy: 'button-clicked' })}
                      className="h-4 w-4 cursor-pointer"
                    />
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={() => setTestParams({ ...testParams, winnerBy: 'manual' })}
                      className="h-4 w-4 cursor-pointer"
                    />
              ...
              {/* Size of the test Group - NO PERCENTAGE BUTTONS */}
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <input
                      type="radio"
                      id="variant-1"
                      name="fallback-winner"
                      checked={testParams.fallbackWinner === 'variant-1'}
                      onChange={() => setTestParams({ ...testParams, fallbackWinner: 'variant-1' })}
                      className="h-4 w-4 cursor-pointer"
                    />
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={() => setTestParams({ ...testParams, fallbackWinner: 'variant-2' })}
                      className="h-4 w-4 cursor-pointer"
                    />
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={() => setTestParams({ ...testParams, fallbackWinner: 'do-later' })}
                      className="h-4 w-4 cursor-pointer"
                    />
      ...
      {editingVariation && (
        <EditVariationDialog
          ...
          variationName={variations.find(v => v.id === editingVariation)?.title}
          onSave={(template) => handleSaveVariation(editingVariation, template)}
        />
      )}
    </>
  );
